...
public class Loader {
	...
	public void addsInstancedAttribute(int vao, int vbo, int attribute, int dataSize, int instancedDataLength, int offset){
		GL15.glBindBuffer(GL15.GL_ARRAY_BUFFER, vbo);
...
//probebly a problem somewhere around here -_-
